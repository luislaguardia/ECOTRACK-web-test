      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mt-6 mb-8 gap-4 flex-wrap">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 flex-wrap">
          ...
          <div className="flex items-center relative">
            <FiSearch className="text-black absolute left-2 top-1/2 transform -translate-y-1/2" />
            <input
              type="text"
              placeholder="Search news..."
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              className="p-2 pl-8 border border-black bg-white rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 font-inter w-full md:w-[350px]"
            />
          </div>
         ...
         {/* Category Select */}
              <div className="relative">
                ...
                <select
                  ...
                  className="shadow-sm border border-black bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 font-inter py-2 px-4 cursor-pointer appearance-none pr-8 w-full md:w-[250px]"
                >
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="shadow-sm border border-black bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 font-inter py-2 px-4 cursor-pointer appearance-none pr-8 w-full md:w-[200px]"
                >
