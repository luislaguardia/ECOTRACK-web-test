...
export default function Settings() {
  ...
  return (
<div className="min-h-screen bg-[#F5F5F5] px-6 md:px-16 py-8">      
      <h2 className="text-3xl font-bold font-inter text-gray-800 mb-8">Account Settings</h2>

      <div className="flex border mb-6 w-full h-13 mx-auto max-w-5xl">        
      ...
      {tab === "profile" && (
        <div className="bg-white rounded-lg shadow-lg px-10 py-12 mx-auto max-w-5xl w-full mb-10">          
          <h3 className="text-xl font-semibold mb-8 text-gray-800">Update Profile</h3>
          <form
            onSubmit={(e) => {
              e.preventDefault();
          ...
          >
            ...
            <button
              type="submit"
              className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 mt-5 rounded-md"
            >
              Save Changes
            </button>
            {message.text && (
      ...
      {tab === "security" && (
        <div className="bg-white rounded-lg shadow-lg p-15 mx-auto max-w-4xl h-125">
          <h3 className="text-xl font-semibold mb-8 text-gray-800">Change Password</h3>
          <form
            onSubmit={(e) => {
              e.preventDefault();
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="fixed inset-0 z-50 flex items-center justify-centerbg-[rgba(0,0,0,0.3)] backdrop-blur-sm ">
